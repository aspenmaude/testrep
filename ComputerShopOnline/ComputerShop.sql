...
-- Dumping data for table computer.customer: ~6 rows (approximately)
/*!40000 ALTER TABLE `customer` DISABLE KEYS */;
INSERT INTO `customer` (`id`, `id_user`, `name`, `address`, `sdt`, `Money`) VALUES
	(1, 'user1', 'nghia', 'HCM', '000777', 21000),
	(2, 'user2', 'Minh', 'Đà Nẵng', '000999', 1000),
	(3, 'user3', 'V.Anh', 'Hà Nội', '000888', 0),
	(11, 'user4', NULL, NULL, NULL, 0),
	(13, 'user5', NULL, NULL, NULL, 1),
	(14, 'user6', NULL, NULL, NULL, 0);
...
-- Dumping data for table computer.order: ~5 rows (approximately)
...
INSERT INTO `order` (`id`, `OrderName`, `id_user`, `id_product`, `OrderDate`) VALUES
	...
	(30, NULL, 'user1', 'LENOVO THINKPAD X1 CARBON GEN 6', NULL),
	(31, NULL, 'user1', 'Dell Inspiron 5593 i5 1035G1 Ram 8Gb MX230 2Gb FHD', NULL);
...
CREATE TABLE IF NOT EXISTS `order_detail` (
  ...
  `id_ProductName` varchar(50) DEFAULT NULL,
...
-- Dumping data for table computer.order_detail: ~5 rows (approximately)
...
INSERT INTO `order_detail` (`id`, `id_order`, `id_ProductName`, `Quantity`) VALUES
	...
	(15, 30, 'LENOVO THINKPAD X1 CARBON GEN 6', 1),
	(16, 31, 'Dell Inspiron 5593 i5 1035G1 Ram 8Gb MX230 2Gb FHD', 1);
...
-- Dumping data for table computer.product: ~6 rows (approximately)
/*!40000 ALTER TABLE `product` DISABLE KEYS */;
INSERT INTO `product` (`id`, `id_category`, `ProductName`, `UnitPrice`, `UnitInStock`) VALUES
	(1, 'thinkpad', 'ThinkPad T490 Core i5 10210U New Seal BH Lenovo Vietnam', 1000, 10),
...
-- Dumping data for table computer.user: ~7 rows (approximately)
