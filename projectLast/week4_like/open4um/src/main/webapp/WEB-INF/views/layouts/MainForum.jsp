...
<link rel="stylesheet"
	...
	<link rel="stylesheet" href="<c:url value="/resources/css/style_disscuss.css" />">
		...
		<div id="forum-page">
						...
						<div class="col-md-3 login-header">
							<div>
								<c:choose>
									...
									<c:otherwise>
										<a href="/open4um/login" style="font-size: 16px;">Đăng Nhập</a>
									</c:otherwise>
								</c:choose>
							</div>
							<div>
			...
			<nav>
				<div class="container">
					<div class="menu-nav">
						<ul>
							<li><a href="#"><i class="fa fa-star"></i></a> <a href="#"><span>Thảo
										Luận Chug </span></a></li>
							<li><a href="#"><i class="fa fa-star"></i></a> <a href="#"><span>Kiến
										Thức cần biết </span></a></li>
							<li><a href="#"><i class="fa fa-calendar-check-o"></i></a> <a
								href="#"><span>Không có sự kiện nào sắp diễn ra</span></a></li>
						</ul>
					</div>
				</div>
			</nav>
