...
<!-- profile -->
    ...
    <link rel="stylesheet" href="resources/css/profileThong.css">
    ...
    <link rel="stylesheet" href="<c:url value="/resources/css/saved.css" />">

    <!-- history-input -->

     <link rel="stylesheet" href="<c:url value="/resources/css/history-input.css" />">
