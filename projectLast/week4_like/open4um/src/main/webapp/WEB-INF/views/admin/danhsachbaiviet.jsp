			...
			<div class="infor-bai-viet">
				<div class="content-wrapper" style="min-height: 774px;">
					...
					<div>
						<div>
							<h3>Posts</h3>
							<a class="btn btn-dark mt-4 mb-4" href="/open4um/admin/quanlybaiviet/add/" role="button">@Thêm Bài Viết</a>
						</div>
					</div>
					<div role="tabpanel">
						...
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="nav-home"
								...
								<table id="mytable" class="table table-bordered table-striped">
									<thead>
										<tr>
											<th class="active tieu-de"><input type="checkbox"
												id="checkAll" name="vehicle1" value="Bike"><span>Tiêu
													Đề</span></th>
									...
									<c:forEach var="list" items="${listproduct}">
										<tbody>
											<tr>
												<td class="active tieu-de"><input type="checkbox"
													class="cb-element" id="vehicle1" name="vehicle1"
													value="Bike"><span>${list.title}</span></td>

												<td class="ten">${list.getUsername()}</td>
												<td class="chuyen-muc">${list.getCtgname()}</td>
												<td class="ngay-dang">${list.getDatepost()}</td>
												<td class="xu-ly"><a
													href="/open4um/admin/quanlybaiviet/${list.proid }">Sửa
														Bài Viết</a></td>
							...
							<div class="tab-pane fade" id="nav-profile" role="tabpanel"
								...
								<table id="mytable1"
									...
									<thead>
										<tr>
											<th class="active tieu-de"><input type="checkbox"
												id="checkAll1" name="vehicle1" value="Bike"><span>Tiêu
													Đề</span></th>
											<th class="tac-gia">Tác Giả</th>
									...
									<c:forEach var="list" items="${duyet}">
										<tbody>
											<tr>
												<td class="active tieu-de"><input type="checkbox"
													id="vehicle1" class="cb-element1" name="vehicle1"
													value="Bike"><span>${list.title}</span></td>
							...
							<div class="tab-pane fade" id="nav-contact" role="tabpanel"
								...
								<table id="mytable2"
									...
									<thead>
										<tr>
											<th class="active tieu-de"><input type="checkbox"
												id="checkAll2" name="vehicle1" value="Bike"><span>Tiêu
													Đề</span></th>
											<th class="tac-gia">Tác Giả</th>
											<th class="chuyen-muc">Chuyên mục</th>
											<th class="ngay-dang">Ngày đăng</th>
									...
									<c:forEach var="list" items="${chuaduyet}">
										<tbody>
											<tr>
												<td class="active tieu-de"><input type="checkbox"
													id="vehicle1" name="vehicle1" class="cb-element2"
													value="Bike"><span>${list.title}</span></td>
