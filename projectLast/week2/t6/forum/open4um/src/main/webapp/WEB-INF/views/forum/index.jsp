	...
	<div class="container">
		...
		<div class="row section-content">
			<div class="col-md-2 menu-left">
				<ul>
					<li><a href="#"><i class="fa fa-globe"></i> </a> <a href="#">Tin
							Tức CNTT </a></li>

					<li><a href="#"><i class="fa fa-laptop"></i> </a> <a href="#">Nghề
							Nghiệp</a></li>

					<li><a href="#"><i class="fa fa-book"></i> </a> <a href="#">Nhập
							Môn Lập Trình</a></li>

					<li><a href="#"><i class="fa fa-free-code-camp"></i> </a> <a
						href="#">Kĩ Thuật Lập trình</a></li>
				</ul>
			</div>
			...
			<div class="col-md-7 content-middle">
				<div class="content-middle-icon">
					<div class="menu-home">
						...
						<div>
							<a href="#"  onclick="menuquick()"><i class="fa fa-caret-square-o-down"
