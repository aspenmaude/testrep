...
<div class="container">
        ...
        <div class="row wrap-panel-source">
            ...
            <div class="col-xl-5 text-center">
                <div class="item-panel-source">
                    <div>
                        <img src="<c:url value="/resources/images/source-game.png"/>" alt="Upload source" class="img-upload-source" /><br/> SOURCE GAME
                    </div>
                </div>
            </div>
            <div class="col-xl-5 text-center">
                <div class="item-panel-source">
                    <div>
                        <img src="<c:url value="/resources/images/source-web.png"/>" alt="Upload source" class="img-upload-source" /><br/> SOURCE WEB
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="title-menu-home-center">
                    <h3><i class="fas fa-laptop-code"></i> TOP SOURCE</h3>
                </div>
                <div class="row">
                    <div class="col-md-4 post-source-item">
                        <div class="img-post-source">
                            <img src="<c:url value="/resources/images/1.jpg"/>" />
                            <div class="cate-post-source"><i class="far fa-file-archive"></i> Game</div>
                        </div>
                        <div class="content-post-source">
                            <a href="#">Chia sẻ code web bán hàng thời trang sử dụng php thuần, Mvc + Báo cáo</a>
                        </div>
                    ...
                    <div class="col-md-4 post-source-item">
                        <div class="img-post-source">
                            <img src="<c:url value="/resources/images/1.jpg"/>" />
                            <div class="cate-post-source"><i class="far fa-file-archive"></i> Web</div>
                        </div>
                        <div class="content-post-source">
                            <a href="#">Chia sẻ code web bán hàng thời trang</a></div>
                        <div class="info-post-source">
                            <div class="info-post-source-left"><i class="fas fa-eye"></i> 435</div>
                            <div class="info-post-source-right"><i class="fas fa-cloud-download-alt"></i> 15</div>
                        </div>
                    ...
                    <div class="col-md-4 post-source-item">
                        ...
                        <div class="content-post-source"><a href="#">Chia sẻ code web bán hàng thời trang sử dụng php thuần, Mvc + Báo cáo</a></div>
                        <div class="info-post-source">
                            <div class="info-post-source-left"><i class="fas fa-eye"></i> 435</div>
                            <div class="info-post-source-right"><i class="fas fa-cloud-download-alt"></i> 15</div>
                        </div>
